...
The trend reversed later in the semester while writing the final paper, when the low group viewed less number of publications and more content pages, while the high group did the opposite (Figure \@ref(fig:rp2-i)(a) and (b)).



The low group spent significantly more time viewing academic publications, in total $(U = 219.0, p = .04, ES = 0.71)$ and on average $(U = 219.0, p = .04, ES = 0.71)$, compared to the high group.
The high group spent more time viewing non-scholarly webpages, while writing the rough draft.


The overall trend is consistent with the findings from Section \@ref(sec-phase2-res-L-dt), that the high group engaged more with web search results and less with scholarly publication search results. 
The high group's preference for non-academic content pages may reflect their use of web search engines to find relevant information, as such search engines often prioritize non-academic content over scholarly publications. On the other hand, the low group's preference for academic publications may reflect their reliance on scholarly publication search engines to find information, as they may have perceived that being the main ask of the research paper. 
...
However, it's important to note that both types of sources can provide valuable information, and a balanced approach that considers a variety of sources may be most effective in conducting comprehensive research. 
