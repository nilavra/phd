...
TODO: add qualitative data from interviews
...
which involved analyzing students' search logs, survey responses, and grades from the proposal stage to the final paper stage. 
...
Then six participants dropped off, and the study was fully completed by ten participants (who stayed till the exit questionnaire, `QSNR3`.)
...
describe the high and low groups appropriately.

Describe stats from `HI` and `LO` profiles, as in YSC Sec 5.1.
