...
The transition entropy of query reformulations showed interesting patterns between the low and high groups (Figure \@ref(fig:ResP3568256736459842466)). 
...
These differences were significant in the beginning and middle of the tasks, and was almost significant over the entire duration of the task $(U = 121.0, p = .0542, ES = 0.32)$.
...
The stationary entropy of query reformulations of the low and high groups varied over the different phases of the research paper writing process (Figure \@ref(fig:ResN4874780073548180653)). 
The low group's stationary entropy decreased from the outline stage to the final paper stage, while the high group's stationary entropy increased from outline to rough draft and then decreased from rough draft to final paper. 
...
The increase in the high group's stationary entropy from outline to rough draft suggests that they were exploring a broader range of topics and concepts at the early stages of the writing process. 
