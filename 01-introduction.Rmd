...
## Searching as Learning: Overview {#sec:intro_overview}
...
## Problem Statement {#sec:intro_problem_statement}
...
## Purpose of this Dissertation Proposal {#sec:intro_purpose}
...
activities (Section [1.1](#sec:intro_overview){reference-type="ref"
reference="sec:intro_overview"}). Therefore, search systems that support
