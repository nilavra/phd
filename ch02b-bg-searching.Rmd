# Background: Information Searching {#ch:bg_search}
...
## Terminology {#sec:bg_search_terminology}
...
## Three-stage Interactions with Online Search Systems {#sec:bg_search_3_stage}
...
### Stage 1: Query (Re)formulation {#sec:bg_search_query}
...
### Stage 2: Search Results Evaluation {#sec:bg_search_list}
...
reference="sec:bg_search_query"} and in
...
Section [1.2.1](#sec:bg_search_query){reference-type="ref"
reference="sec:bg_search_query"} that users strongly preferred issuing
...
### Stage 3: Content Page Evaluation {#sec:bg_search_content_page}
...
pattern of viewing
(Section [1.2.2](#sec:bg_search_list){reference-type="ref"
reference="sec:bg_search_list"}), paying the most attention to the top
two entries.

## Effects of Expertise and Working Memory on Search Behaviour {#sec:bg_search_expertise}
...
reference="ch:bg_learn"}, learning and expertise are closely connected:
...
reference="sec:bg_learn_artefact"}). **Visual mapping** techniques such
...
reference="sec:bg_concept_maps"}. Learning has also been measured in
...
### Longitudinal studies {#sec:bg_search_longitudinal_studies}
...
reference="sec:bg_learn_principles"}). Therefore, information
...
### Supporting sensemaking and reflection {#sec:bg_search_sensemaking}

As we saw in Section
[\[sec:bg_learn_sensemaking\]](#sec:bg_learn_sensemaking){reference-type="ref"
reference="sec:bg_learn_sensemaking"}, learning *is* sensemaking. Yet,
