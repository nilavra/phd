...
[\[ch-bg-learn\]](#ch-bg-learn){reference-type="ref"
reference="ch-bg-learn"}) and Information (Chapter
[\[ch-bg-search\]](#ch-bg-search){reference-type="ref"
reference="ch-bg-search"}), we saw that:

-   searching for information online is an integral part of new learning
    (Section
    [\[sec-bg-learn-info-eval\]](#sec-bg-learn-info-eval){reference-type="ref"
    reference="sec-bg-learn-info-eval"})
...
-   learning happens when students connect new pieces of information to
    ...
    or tuning (Section
    [\[sec-bg-learn-sensemaking\]](#sec-bg-learn-sensemaking){reference-type="ref"
    reference="sec-bg-learn-sensemaking"}), and this process is
    influenced by the learner's individual traits (Section
    [\[sec-bg-learn-promoting-learning\]](#sec-bg-learn-promoting-learning){reference-type="ref"
    reference="sec-bg-learn-promoting-learning"})
...
-   modern knowledge-work requires less of long term memory, and more of
    ...
    reference="sec-bg-learn-artefact"})

-   domain expertise and search behaviour are strongly linked (Section
    [\[sec-bg-search-expertise\]](#sec-bg-search-expertise){reference-type="ref"
    reference="sec-bg-search-expertise"})

-   learning is a process that takes place longitudinally over time
    (Sections
    [\[sec-bg-learn-sensemaking\]](#sec-bg-learn-sensemaking){reference-type="ref"
    reference="sec-bg-learn-sensemaking"} and
    [\[sec-bg-learn-principles\]](#sec-bg-learn-principles){reference-type="ref"
    reference="sec-bg-learn-principles"}), yet only a handful of studies
    ...
    over time (Section
    [\[sec-bg-search-longitudinal-studies\]](#sec-bg-search-longitudinal-studies){reference-type="ref"
    reference="sec-bg-search-longitudinal-studies"})
...
[\[sec-method-exp-design\]](#sec-method-exp-design){reference-type="ref"
reference="sec-method-exp-design"}). For the purposes of this
...
[1.2](#sec-rq-hypotheses){reference-type="ref"
reference="sec-rq-hypotheses"}.
...
[\[sec-bg-search-expertise\]](#sec-bg-search-expertise){reference-type="ref"
reference="sec-bg-search-expertise"}). There is a clear gap in
...
reference="tab-search-behaviours"} will occur both within individual
...
[\[sec-bg-learn-articulation\]](#sec-bg-learn-articulation){reference-type="ref"
reference="sec-bg-learn-articulation"}). Also, students' motivation,
self-regulation and metacognition capabilities determine, direct, and
sustain the approaches they take to learn (Section
[\[sec-bg-learn-promoting-learning\]](#sec-bg-learn-promoting-learning){reference-type="ref"
reference="sec-bg-learn-promoting-learning"}). Effective searching for
learning is affected by students' search tactics and information
evaluation capabilities (Section
[\[sec-bg-learn-info-eval\]](#sec-bg-learn-info-eval){reference-type="ref"
reference="sec-bg-learn-info-eval"}) as well as cognitive capabilities
...
[\[sec-intro-outline\]](#sec-intro-outline){reference-type="ref"
reference="sec-intro-outline"}), our research questions aim to
...
[@zlatkin2021students; @kelly2009evaluation; @HCIUXres81-online]. If
