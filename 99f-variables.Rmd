...
## Query Reformulation Variables {#sec:app_vars_qry}
...
## SERP / Content Page Examination variables {#sec:app_vars_serp_content_pg}

-   **Transition Type:** how the browser navigated to a particular URL
    on a particular visit (Appendix
    [1.6](#sec:app_vars_transition_typ){reference-type="ref"
    reference="sec:app_vars_transition_typ"})
...
## SERP-only variables {#sec:app_vars_serp}
...
## Content page-only variables {#sec:app_vars_content_pg}

-   **Avg. Content dwell time per query:** Total content page dwell time
    / #queries [@collins2016assessing]

## Overall Search Behaviour {#sec:app_vars_overall_search}
...
## Webpage Transition Types {#sec:app_vars_transition_typ}
...
## Concept Map Analysis Measures {#sec:app_vars_concept_maps}
