# Background: Knowledge and Learning {#ch:bg_learn}
...
## Terminology {#sec:bg_learn_terminology}

The Webster dictionary[^1] defines **knowledge** in two ways. The first
...
![image](figs/deep_learning_surface_learning.pdf){width="\\linewidth"}

![ Meaningful learning (ake deep learning) as explained by
@novak2010learninga [Fig. 5.3] (annotations our own).
](figs/meaningful_learning.pdf){#fig_meaningful_learning
width="0.7\\linewidth"}
...
social and practical settings [@sawyer2005cambridge]. Deep learning[^2]
...
contrasted with *surface learning* or *rote learning*. Table
[\[tab_deep_learning_surface_learning\]](#tab_deep_learning_surface_learning){reference-type="ref"
reference="tab_deep_learning_surface_learning"} discusses some more
...
[1.1](#fig_meaningful_learning){reference-type="ref"
reference="fig_meaningful_learning"} describes (using a concept map) how
...
## Principles of Meaningful Learning {#sec:bg_learn_principles}
...
4.  Goal-directed practice coupled with **targeted feedback** enhances
    the quality of students' learning.

5.  Students' current level of development interacts with the social,
    emotional, and intellectual **context** around the student to impact
    learning.

6.  To become **self-directed** learners, students must learn to
...
## Meaningful Learning as Sensemaking {#sec:bg_learn_sensemaking}

In this section, we discuss how meaningful learning can be further
qualified using the concepts of sensemaking. **Sensemaking**[^3] is a
...
### Concept Maps to enhance Sensemaking {#sec:bg_concept_maps}

![ Concept Map showing the key features of Concept Maps
[@moon2011applieda Fig. 1.1].
](figs/concept_map_desc.pdf){#fig_concept_map_desc width="\\linewidth"}
...
map. Figure  [1.2](#fig_concept_map_desc){reference-type="ref"
reference="fig_concept_map_desc"} shows the key features of a concept
...
## 'New' Learning as Online Information Searching {#sec:bg_learn_active_knowledge_multiliteracy}
...
[\[sec:intro_overview\]](#sec:intro_overview){reference-type="ref"
reference="sec:intro_overview"}).

### Active Knowledge Making {#sec:bg_learn_active_knowledge_making}
...
::: displayquote
Learners become **active knowledge producers** (for instance,
...
economy' and 'knowledge society' attributes. -- [@cope2017elearningc]
:::

### Artefacts for Learning Assessment {#sec:bg_learn_artefact}
...
ubiquitously[^4] to a learner (or a knowledge worker), in every moment
...
work today: *"if we are not going to measure and value long-term memory
in education, what are we going to assess?"* [@cope2017elearningc]
suggest that **we assess the knowledge artefacts** that learners
produce. In active knowledge making, the final work[^5] can be proof of
the learning outcome and represent a learner's ability to use the
resources that are available [@amina2017active]. **Measure of learning
...
### 'Information Search and Evaluation' as and for Learning {#sec:bg_learn_info_eval}
...
Online Reasoning** (COR) curriculum[^6] to enable students to
...
## Promoting Better Learning {#sec:bg_learn_promoting_learning}
...
### Externalization and Articulation {#sec:bg_learn_articulation}
...
### Metacognition and Reflection {#sec:bg_learn_metacognition}

![image](figs/metacognition_components.pdf){width="\\linewidth"}
...
(Section [1.5.4](#sec:bg_learn_self_regulation){reference-type="ref"
reference="sec:bg_learn_self_regulation"}. Effective learners are aware
...
[\[tab_metacognition_components\]](#tab_metacognition_components){reference-type="ref"
reference="tab_metacognition_components"}. [@schraw1994assessing]
...
questions (Appendix [\[app:mai\]](#app:mai){reference-type="ref"
reference="app:mai"}), such as "I consider several alternatives to a
...
](figs/sdt_components.pdf){#fig_sdt_components width="\\linewidth"}
...
as illustrated in Figure [1.3](#fig_sdt_components){reference-type="ref"
reference="fig_sdt_components"}. Extrinsic motivation does not last
...
### Self-regulation {#sec:bg_learn_self_regulation}
...
[@saks2014distinguishing]. ](figs/sdl_v_srl.pdf){#fig_sdl_v_srl
width="0.8\\linewidth"}
...
differences (Figure [1.4](#fig_sdl_v_srl){reference-type="ref"
reference="fig_sdl_v_srl"}) [@saks2014distinguishing]. SDL, originating
...
## Summary and Implications for this Proposal {#sec:bg_learn_summary}
...
[^3]: "Brenda Dervin, one of the originators of the sense-making
    methodology, prefers the spelling with a hyphen, while the community
    in computer science and more technical people in information science
    (e.g., SIGCHI) use sensemaking without a hyphen" --
    [@zhang2014towards].

[^4]: as long as there is internet connection

[^5]: be it a project report, poster, presentation, video, software,
    research paper, website, etc.

[^6]: <https://cor.stanford.edu>
