...
[@kelly2009evaluation; @koeman2020hciux; @zlatkin2021students; @karapanos2021advances].
Very few studies exist in the search-as-learning domain that have observed *the same participant* over a longer period of time than a single search session [@kelly2006measuringa; @kelly2006measuringb; @kuhlthau2004seeking; @wildemuth2004effects; @vakkari2001changes; @white2009characterizing].
This ephemeral approach has acute implications in any domain where learning is involved because "learning is a *process* that leads to *change* in knowledge ... (which) unfolds over time" [@ambrose2010howa], and "...does not happen all at once" [@white-2016-iwss-learning].
...
>
> `r nbQuoteAuthor('--- @koeman2020hciux')`
...
## Purpose of this Dissertation {#sec-intro-purpose}
