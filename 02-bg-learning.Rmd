# Background: Knowledge and Learning {#ch_bg_learn}
...
## Terminology {#sec_bg_learn_terminology}
...
## Principles of Meaningful Learning {#sec_bg_learn_principles}
...
## Meaningful Learning as Sensemaking {#sec_bg_learn_sensemaking}
...
### Concept Maps to enhance Sensemaking {#sec_bg_concept_maps}
...
## 'New' Learning as Online Information Searching {#sec_bg_learn_active_knowledge_multiliteracy}
...
[\[sec_intro_overview\]](#sec_intro_overview){reference-type="ref"
reference="sec_intro_overview"}).

### Active Knowledge Making {#sec_bg_learn_active_knowledge_making}
...
### Artefacts for Learning Assessment {#sec_bg_learn_artefact}
...
### 'Information Search and Evaluation' as and for Learning {#sec_bg_learn_info_eval}
...
## Promoting Better Learning {#sec_bg_learn_promoting_learning}
...
### Externalization and Articulation {#sec_bg_learn_articulation}
...
### Metacognition and Reflection {#sec_bg_learn_metacognition}
...
(Section [1.5.4](#sec_bg_learn_self_regulation){reference-type="ref"
reference="sec_bg_learn_self_regulation"}. Effective learners are aware
...
questions (Appendix [\[app_mai\]](#app_mai){reference-type="ref"
reference="app_mai"}), such as "I consider several alternatives to a
...
(Appendix [\[app_imi\]](#app_imi){reference-type="ref"
reference="app_imi"}), a multidimensional questionnaire intended to
...
### Self-regulation {#sec_bg_learn_self_regulation}
...
[\[app_srq\]](#app_srq){reference-type="ref" reference="app_srq"}) to
...
## Summary and Implications for this Proposal {#sec_bg_learn_summary}
