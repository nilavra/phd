...
<!----------- fig:deep-learning-surface-learning ----------->
```{r deep-learning-surface-learning, fig.scap='(ref:scap-deep-learning-surface-learning)', fig.cap = '(ref:cap-deep-learning-surface-learning)',  echo=FALSE, out.width='100%', fig.align='center'}
nbShowFig("figs/deep-learning-surface-learning")
```
<!-- each text reference needs to be their own single paragraph ! -->
(ref:cap-deep-learning-surface-learning) Deep learning (of the human kind) versus traditional (also often online) classroom practices. Compiled from @cope2017elearningc and @sawyer2005cambridge.

(ref:scap-deep-learning-surface-learning) Learning knowledge deeply vs. traditional classroom practices.

<!--- fig:deep-learning-surface-learning (leave a blank line before this) ---->
...
<!----------- fig:meaningful-learning ----------->
```{r meaningful-learning, fig.scap='(ref:scap-meaningful-learning)', fig.cap = '(ref:cap-meaningful-learning)',  echo=FALSE, out.width='70%', fig.align='center'}
nbShowFig("figs/meaningful-learning")
```
<!-- each text reference needs to be their own single paragraph ! -->
(ref:cap-meaningful-learning) Meaningful learning (aka deep learning) as explained by Novak [-@novak2010learninga Fig. 5.3] (annotations our own).

(ref:scap-meaningful-learning) Meaningful learning.

<!--- fig:meaningful-learning (leave a blank line before this) ----->
...
social and practical settings [@sawyer2005cambridge]. Deep learning ^[of the human kind] takes place when "the learner chooses conscientiously to integrate new
...
for deep learning [@marton1976qualitative-a; @marton1976qualitative-b]
...
piece of information [@ngss-sensemaking]. A significant portion of
...
goals [@ngss-sensemaking]. [@dervin2010sensemaking] distinguish work on
...
> `r nbQuoteAuthor('--- @cope2017elearningc')`
>
...
than the expansive fields of media and digital literacy ^[
    *"Digital literacy describes a holistic approach to cultivating skills that allow people to participate meaningfully in online communities, interpret the changing digital landscape, understand the relationships between systemic -isms and information, and unlock the power of digital tools for good. This includes media literacy. Terms like critical media literacy, media literacy, news literacy, and more are not necessarily interchangeable."* -- @collins2021reimagining
], (which can embrace topics ranging from cyberbullying to identity theft). 
...
twenty-first century [@breakstone2021students; @kahne2012digital; @mihailidis2013media].
...
<!----------- fig:metacognition-components ----------->
```{r metacognition-components, fig.scap='(ref:scap-metacognition-components)', fig.cap = '(ref:cap-metacognition-components)',  echo=FALSE, out.width='100%', fig.align='center'}
nbShowFig("figs/metacognition-components")
```
<!-- each text reference needs to be their own single paragraph ! -->
(ref:cap-metacognition-components) Operational definitions and features of the metacognition components, adapted from @schraw1994assessing and @viu2021mai.

(ref:scap-metacognition-components) Components of metacognition.

<!---- fig:metacognition-components (leave a blank line before this) ------>
...
@schraw1994assessing developed the **Metacognitive Awareness Inventory** (MAI) survey and a
...
questions (Appendix \@ref(app-qsnr-mai)), such as "*I consider several alternatives to a problem before I answer*", "*I understand my intellectual strengths and weaknesses*", "*I have control over how well I learn", and "I change strategies when I fail to understand*".
The instrument has been widely used in research, and has its reliability and validity measures available. Later, @terlecki2018call proposed a revised version of the MAI, using five-point Likert-scales, ranging from "*I never do this*" to "*I do this always*".
They argue that when measuring change in metacognition over time, the Likert-scale based 'how often' questions are more effective than dichotomous 'Yes/No' questions [@terlecki2018call; @terlecki2020revising].

### Motivation

<!----------- fig:sdt-components ----------->
```{r sdt-components, fig.scap='(ref:scap-sdt-components)', fig.cap = '(ref:cap-sdt-components)',  echo=FALSE, out.width='100%', fig.align='center'}
nbShowFig("figs/sdt-components")
```
<!-- each text reference needs to be their own single paragraph ! -->
(ref:cap-sdt-components) The motivation and self-determination continuum, as proposed by the Self-Determination Theory (SDT). Figure adapted from @ryan2000intrinsic, @ryan2000self, and @guyan2013improving.

(ref:scap-sdt-components) Motivation and self-determination continuum.

<!---- fig:sdt-components (leave a blank line before this) ------>
...
behavioural measures of intrinsic motivation. The *pressure/tension* is
...
it is used if it is relevant. The *value/usefulness* subscale is used to
...
of @kanfer1970self-a; @kanfer1970self-b, Miller and Brown formulated a
...
@brown1999self developed the **Self-Regulation Questionnaire** (SRQ) (Appendix
\@ref(app-qsnr-srq)) to
...
<!----------- fig:sdl-v-srl ----------->
```{r sdl-v-srl, fig.scap='(ref:scap-sdl-v-srl)', fig.cap = '(ref:cap-sdl-v-srl)',  echo=FALSE, out.width='80%', fig.align='center'}
nbShowFig("figs/sdl-v-srl")
```
<!-- each text reference needs to be their own single paragraph ! -->
(ref:cap-sdl-v-srl) Self-directed learning vs. self-regulated learning, as illustrated by @saks2014distinguishing.

(ref:scap-sdl-v-srl) Self-directed learning vs. self-regulated learning.

<!---- fig:sdl-v-srl (leave a blank line before this) ------>
...
differences (Figure \@ref(fig:sdl-v-srl)) [@saks2014distinguishing]. SDL, originating
...
[@jossberger2010challenge; @loyens2008selfdirected]. In other words, *"a self-directed learner is supposed to self-regulate, but a self-regulated learner may not self-direct"* [@saks2014distinguishing]. Despite their
differences, SDL and SRL share key similarities
[@saks2014distinguishing]. 
First, both can be seen in two dimensions:
*(i)* *external* to the learner, as a process or series of events, and
*(ii)* *internal* to the learner, arising from the learner's personality, aptitude, and individual differences. 
Second, both the
learning processes have four key phases: 
*(i)* defining tasks, 
*(ii)* setting goals and planning, 
*(iii)* enacting strategies, and 
*(iv)* monitoring and reflecting. 
...
## Summary and Implications for this Dissertation {#sec-bg-learn-summary}
...
<!-- Concept maps are better suited to represent the learning and sensemaking process, and artefacts are better able to demonstrate a learner's knowledge work. -->
