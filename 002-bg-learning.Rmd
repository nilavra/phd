...
```{r meaningful-learning, fig.scap='(ref:scap-meaningful-learning)', fig.cap = '(ref:cap-meaningful-learning)',  echo=FALSE, out.width='100%', fig.align='center'}
nbShowFig("figs/meaningful-learning")
```
<!-- each text reference needs to be their own single paragraph ! -->
(ref:cap-meaningful-learning) Meaningful learning (ake deep learning) as explained by Novak [-@novak2010learninga Fig. 5.3] (annotations our own).
...
questions (Appendix \@ref(app-mai)), such as "*I consider several alternatives to a problem before I answer*", "*I understand my intellectual strengths and weaknesses*", "*I have control over how well I learn", and "I change strategies when I fail to understand*".
...
<!----------- fig:sdl-v-srl ----------->
```{r sdl-v-srl, fig.scap='(ref:scap-sdl-v-srl)', fig.cap = '(ref:cap-sdl-v-srl)',  echo=FALSE, out.width='100%', fig.align='center'}
