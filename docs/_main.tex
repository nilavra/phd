...
The average number of queries issued by the high group were the highest before the Outline (\texttt{PHASE2B}).
...
Even, one participant commendted ``I had downloaded all the papers I needed during\ldots{}''
...
\hypertarget{entropy-of-query-qeformulation}{%
\subsection{Entropy of Query Qeformulation}\label{entropy-of-query-qeformulation}}

\hypertarget{transition-entropy-of-query-qeformulation}{%
\subsubsection{Transition Entropy of Query Qeformulation}\label{transition-entropy-of-query-qeformulation}}
