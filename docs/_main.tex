...
\begin{spacing}{1.5}
  ...
  \textbf{Jacek suggested writing a Bengali version of the abstract.}
  আমার পিএইচডি এডভাইসর বললেন যে থিসিস এর সারসংক্ষেপ এর একটা বাংলা সংস্করণ ও লিখতে। উনি ওনার থিসিস এর সারসংক্ষেপ ইংরেজি এবং পোলিশ দুই ভাষায় লিখেছিলেন।
