...
% bengali fonts-- need to put them before call to fontspec
% in .cls file
...
% \usepackage{fontspec}    
% \newfontface\dispnamefont{kalpurush.ttf}
...
\begin{center}
  ...
  \begin{spacing}{1.4}
    ...
    Nilavra Bhattacharya 
    {\dispnamefont নীলাভ্র ভট্টাচার্য্য}, 
    PhD TBD\\
    The University of Texas at Austin, 
    2023\\
    \vspace{18pt}
...
{\centering \includegraphics[width=1\linewidth]{figs/meaningful-learning} 

}

\caption[Meaningful learning.]{Meaningful learning (ake deep learning) as explained by Novak (\protect\hyperlink{ref-novak2010learninga}{2010, fig. 5.3}) (annotations our own).}\label{fig:meaningful-learning}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{figs/sdl-v-srl} 
...
\caption[Components of metacognition.]{Literature reviews by Rieh et al.~(2016) and Vakkari (2016) identified the following search behavioural traits as indicative of domain experts, or novices undergoing learning to become experts.}\label{fig:search-behaviours}
\end{figure}
