...
\begin{spacing}{1.5}
  \indent
  % \indent
  \secondlanguage{বর্তমান যুগে শিক্ষালাভ এবং দৈনন্দিন জীবনযাপনের একটা বড় অংশ হলো ইন্টারনেট থেকে সঠিক তথ্য বা ইনফরমেশন খুঁজে বার করে তার থেকে জ্ঞান অর্জন করা।
