...
\item
  ...
  \item
    A time span of less than 5 seconds is a too short period for being able to read a summary and extract information (\protect\hyperlink{ref-he2016beyond}{He et al., 2016}).
  \end{itemize}
\item
  med
...
\hypertarget{level-1-moves---tab-parallel-browsing-behaviour}{%
\section{Level 1: Moves - Tab (Parallel Browsing) Behaviour}\label{level-1-moves---tab-parallel-browsing-behaviour}}
...
\item
  ...
  \end{itemize}
\item
  Session Events (from YASBIL events and \texttt{task\_id})
...
\item
  Tab.\{tab events\}
\item
  Idle: user stays idle for 1 minute (\protect\hyperlink{ref-taramigkou2018leveraging}{Taramigkou et al., 2018})
\item
