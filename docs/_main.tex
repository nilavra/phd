...
\caption[Longitudinal study procedure.]{Longitudinal study procedure with long caption containing \textbf{bold} and \emph{italic} text, which is not possible from within \texttt{R\ code}.}\label{fig:study-proc}
\end{figure}
...
\subsection{\texorpdfstring{\texttt{QSNR0}: Recruitment Questionnaire}{QSNR0: Recruitment Questionnaire}}\label{sec-method-qsnr0}}
...
\hypertarget{demographics-appendix-refapp-qsnr-demographics}{%
\subsubsection{Demographics (Appendix \ref{app-qsnr-demographics})}\label{demographics-appendix-refapp-qsnr-demographics}}
...
To assess participants' (mis)information evaluation capabilities, they performed a website reliability assessment created by the Stanford History Education Group (SHEG) (\protect\hyperlink{ref-sheg2021website-reliability}{2021b}).
...
\hypertarget{phase3-sheg-webpage-comparison-assessment}{%
\subsubsection{\texorpdfstring{\texttt{PHASE3-SHEG}: Webpage Comparison Assessment}{PHASE3-SHEG: Webpage Comparison Assessment}}\label{phase3-sheg-webpage-comparison-assessment}}

To assess participants' (mis)information evaluation capabilities, they performed a Website Comparison assessment created by the Stanford History Education Group (SHEG) (\protect\hyperlink{ref-sheg2021webpage-comparison}{Stanford History Education Group (SHEG), 2021a}).
...
\subsection{QSNR3: Exit Questionnaire}\label{sec-method-qsnr3}}
