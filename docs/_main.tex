...
\hypertarget{sec-analysis-entropy}{%
\section{Entropy Analyses of Search Behaviour Sequences}\label{sec-analysis-entropy}}
...
As introduced in Section \ref{sec-analysis-entropy}, we carried out entropy analysis of query reformulation sequences produced by the participants.
