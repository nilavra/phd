...
\hypertarget{level-1-moves---dwell-time}{%
\section{Level 1: Moves - Dwell Time}\label{level-1-moves---dwell-time}}
...
- Struggling vs.~Exploring (p 204), originally in (\protect\hyperlink{ref-hassan2014struggling}{Hassan et al., 2014})
- predictive of struggling:
...
\hypertarget{strategies-from-dwell-time}{%
\subsection{Strategies from Dwell Time}\label{strategies-from-dwell-time}}
...
\hypertarget{strategies-from-analysis3}{%
\subsection{Strategies from Analysis3}\label{strategies-from-analysis3}}
...
\hypertarget{level-2-search-trails}{%
\section{Level 2+: Search Trails}\label{level-2-search-trails}}
