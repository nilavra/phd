...
\hypertarget{latent-profiles}{%
\section{Latent Profiles}\label{latent-profiles}}
...
Using the taxonomy proposed by C. Liu et al. (\protect\hyperlink{ref-liu2010analysis}{2010}) (Figure \ref{fig:res-Q-QRT-txnmy}), we classified each previous-next query pair issued by participants into one of the five query reformulation types:
New,
Generalization,
Specialization,
Word Substitution,
...
\hypertarget{entropy-of-query-reformulation}{%
\subsection{Entropy of Query Reformulation}\label{entropy-of-query-reformulation}}
...
\hypertarget{comment-out-old-content---remove-everything-from-here}{%
\section{------------ COMMENT OUT: Old Content - Remove everything from here ------------}\label{comment-out-old-content---remove-everything-from-here}}
...
\hypertarget{rq2-repeated-vs-new-tasks}{%
\section{RQ2: repeated vs new tasks}\label{rq2-repeated-vs-new-tasks}}
