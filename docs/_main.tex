...
The results of the LPA showed that there were two distinct latent profiles of participants based on their scores on the IMI, MAI, and SRQ: a high group and a low group (Figure \ref{fig:lpa-profile-means}). The high group had generally higher scores on the IMI, MAI, and SRQ compared to the low group, indicating that they were more intrinsically motivated, more aware of their metacognitive processes, and had higher levels of self-regulation.
...
\section{Entropy Analysis of Querying Behaviour}\label{sec-res-phase13-query-H}}
