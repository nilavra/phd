...
\hypertarget{implicit-features-for-exploratory-search-process}{%
\section{Implicit Features for Exploratory Search Process}\label{implicit-features-for-exploratory-search-process}}
...
\tightlist
\item
  Creativity --\textgreater{} Information Novelty
...
\item
  ...
  \end{itemize}
\item
  Knowledge Discovery --\textgreater{} Finding useful and relevant information
...
\hypertarget{search-tactics-and-strategies}{%
\section{Search Tactics and Strategies}\label{search-tactics-and-strategies}}

From White (\protect\hyperlink{ref-white2016interactions}{2016a}), Table 2.1:
...
\hypertarget{analysis-1---based-on-dwell-time}{%
\subsection{Analysis 1 - based on Dwell Time}\label{analysis-1---based-on-dwell-time}}
...
\item
  ...
  \tightlist
  \item
    short (1 \textless= DT \textless= 5s)
  \item
    med (5 \textless{} DT \textless= 30s)
  \item
    long (DT \textgreater{} 30s) (from Handehawa's thesis, and related Shah references)
  \end{itemize}
\item
...
\hypertarget{analysis-2---using-webpage-l2-categories}{%
\subsection{Analysis 2 - using webpage L2 categories}\label{analysis-2---using-webpage-l2-categories}}
...
\tightlist
\item
  As in (\protect\hyperlink{ref-lam2007session}{Lam et al., 2007}) Sec 6:
  ...
  \item
    Methodical Results Exploration: S -\textgreater{} X -\textgreater{} S -\textgreater{} X -\textgreater{} S -\textgreater{} \ldots{}
  \item
    Query Refinement: S -\textgreater{} S -\textgreater{} S -\textgreater{} S -\textgreater{} \ldots{}
  \end{itemize}
\item
...
\hypertarget{original-idea}{%
\subsection{Original Idea}\label{original-idea}}
...
\item
  L
\item
  I\_short (DT \textless= 10s) -- rethink these durs
\item
...
\hypertarget{search-trails-analysis}{%
\section{search trails analysis}\label{search-trails-analysis}}
...
\item
  \url{https://rucore.libraries.rutgers.edu/rutgers-lib/49207/PDF/1/}
\item
  maybe future work?
\end{itemize}
