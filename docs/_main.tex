...
\tightlist
\item
  DO ALAYSIS WITH \texttt{LIB} AND \texttt{LIBGUIDE} TYPE URLS - LIBRARY WEBSITES
\end{itemize}
...
\tightlist
\item
  Pernilla Q et al's paper: Jiyin He, Pernilla Qvarfort, Martin Halvey, Gene Golovchinsky. Beyond actions: Exploring the discovery of tactics from user logs. In Information Processing \& Management, vol.~52, issue 6, Nov.~2016, pp.~1200--1226. \url{http://dx.doi.org/10.1016/j.ipm.2016.05.007}
  ...
  \end{itemize}
\item
  other search tactics from \emph{Search Patterns} book
...
\hypertarget{tab-transition-parallel-browsing-behaviour}{%
\subsection{tab transition / parallel browsing behaviour}\label{tab-transition-parallel-browsing-behaviour}}
