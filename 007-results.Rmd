...
Using the taxonomy proposed by @liu2010analysis (Figure \@ref(fig:res-Q-QRT-txnmy)), we classified each previous-next query pair issued by participants into one of the five query reformulation types:
New,
Generalization,
Specialization,
Word Substitution,
