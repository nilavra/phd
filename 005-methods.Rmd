...
```{r fig-study-proc-diss, fig.cap = '(cap-fig-study-proc-diss)', fig.scap='Short Caption for LoF', echo=FALSE, out.width='100%', fig.align='center'}
#knitr::include-graphics("figs/study-procedure-CHI-SRC2.svg")
nbShowFig("figs/fig-study-proc-diss")
```
