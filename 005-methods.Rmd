...
1. **Consent Form:** (Appendix \@ref(app-qsnr-consent-form))
    The first page of QSNR1 was the
...
1. **Demographics:** (Appendix \@ref(app-qsnr-demographics))
...
1. **Motivation:** (Appendix \@ref(app-qsnr-imi))
...
2. **Self-regulation:** (Appendix \@ref(app-qsnr-srq))
...
3. **Metacognition:** (Appendix \@ref(app-qsnr-mai))
...
For the Initial Phase (PHASE1), participants were invited to a
remote study session over the Zoom video-conferencing platform. The
purpose of PHASE1 was to establish baseline search
behaviour and domain knowledge of the participants. The study
consisted of a training task, two actual search tasks, one website
reliability assessment, and a memory span test. Each of these components
are described below.

1.  **Training Task:** Participants performed a training task to
    familiarize themselves with how to operate the YASBIL browser
    extension to log their browsing activity.
    The training task took around 2-5 minutes.

2.  **Actual Search Tasks:** Participants performed two search tasks: -- `PHASE1-FINANCE`, and `PHASE1-UBUNTU`, of
    which the `PHASE1-FINANCE` was repeated at the end of the semester as `PHASE3-FINANCE`. 
    in the final session \[SES3\] at the end
