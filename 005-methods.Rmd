...
```{r fig-study-proc, fig.cap = 'Very very very very very very very very long caption.', fig.scap='Short Caption for LoF', echo=FALSE, out.width='100%', fig.align='center'}
# knitr::include_graphics(rep("figs/study_procedure_CHI_SRC2.svg"))
```
