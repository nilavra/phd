...
](figs/int-Q.pdf){#fig:int-Q width="\\linewidth"} 
-->
...
```
<!-- each text reference needs to be their own single paragraph ! -->
(ref:cap-search-behaviours) Literature reviews by Rieh et al. (2016) and Vakkari (2016) identified the following search behavioural traits as indicative of domain experts, or novices undergoing learning to become experts.
