...
\documentclass[letterpaper, $if(page-layout)$$page-layout$$else$nobind$endif$]{templates/ociamthesis}
...
\hypersetup{
    ...
    linktoc=all,
    pdftitle={$title$},
    pdfauthor={$author$ $author-second-language$},
...
\begin{center}
  ...
  % author + supervisor
  \begin{spacing}{1.4}
    % $author$ $author-second-language$, $degree-suffix$\\
    $author$ 
...
\thispagestyle{plain} % plain page numbers
\begin{center}
  \textbf{\secondlanguage{$abstract-second-language-heading$} (Abstract in $second-language$)}\\
  
  \vspace{18pt}
  
  % title
  \begin{spacing}{2}
    \secondlanguage{\Large{\textbf{$title-second-language$}}}
  \end{spacing}
  ...
  \begin{spacing}{1.4}
    % $author$ $author-second-language$, $degree-suffix$\\
    % $author$ 
    \secondlanguage{$author-second-language$, $degree-suffix-second-language$}\\
...
\begin{spacing}{1.5}
  \indent
  % \indent
  \secondlanguage{$abstract-second-language$}
\end{spacing}
